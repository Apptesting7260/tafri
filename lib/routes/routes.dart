...
class Routes{
  ...
  static List<GetPage<dynamic>>? listRoutes=[
    ...
    GetPage(name: planMemUi, page:()=>PlansUi(),binding: PlanBinding()),
    GetPage(name: myprofileInnUi, page:()=>MyProfileUi(),binding: MyprofileInnbinding()),
    GetPage(name: addPhotoProUi, page:()=>AddPhotoUi(),binding: AddphotoBinding()),
    GetPage(name: activityInterestUi, page:()=>ActivityInterestUi(),binding: ActivinterestBinding()),
    GetPage(name: locationProUi, page:()=>const LocationProUi(),binding: LocationBinding()),
    GetPage(name: occupationProUi, page:()=>const OccupationUi(),binding: OccupationBinding()),
    ...
    GetPage(name: verifySocialMedProUi, page:()=>const GetVerifyUi(),binding: LanguageproBinding()),
    ...
    GetPage(name: upcommingUserActiUi, page:()=> const UpcommingUserActivityUi(),binding:UpCommingActiUserBinding()),

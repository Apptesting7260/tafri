...
import 'package:plusone/payment/update_billing_screen.dart';
...
import 'package:plusone/uis/explore/Userprofile/userprofileui.dart';
...
import 'package:plusone/uis/explore/search/bindings/searchact_binding.dart';
import 'package:plusone/uis/explore/search/searchactui.dart';
...
import 'package:plusone/uis/message/chats/chat_photo_screen.dart';
...
class Routes{
  ...
  static List<GetPage<dynamic>>? listRoutes=[
    ...
    GetPage(name: exploreUi, page:()=> ExploreUi(),bindings: [ExploreListBindings(),FilterExpBinding()]),
    GetPage(name: profilemain, page:()=> ProfileUi(),binding: ProfilemainBindings()),
    GetPage(name: messageListUi, page:()=> MessageListUi(),binding: MsglistBinding()),
    ...
    GetPage(name: settingProUi, page:()=> SettingUi(),bindings: [SettingBinding(),PushnotifisettingBinding()]),
    ...
    GetPage(name: hostUpcommingActiview, page:()=>  HostUpcomActivityViewUi(),bindings: [HostUpcommiActiBindings(),MyactBinding(),ChatBinding()]),

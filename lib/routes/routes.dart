...
class Routes{
  ...
  static List<GetPage<dynamic>>? listRoutes=[
    ...
    GetPage(name: activityInterestUi, page:()=>const ActivityInterestUi(),binding: ActivinterestBinding()),
    ...
    GetPage(name: previousActivityUi, page:()=>  const PreviousActivityUi(),binding:PreviousActiBindings()),

...
class AttendListUi extends GetView<AttendlistController>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Obx(() => controller.activityLoading.value ? Center(child: CommonUi.scaffoldLoading(color: clrYellow)) : controller.attError.value.isNotEmpty? const Center(child: ErrorScreen()) :  Padding(

                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Image.asset("assets/icons/actshare.png",color: clrWhite,height: 20,width: 20,),//
                          ),
                        ),
                      ),
                ...
                child: Obx(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text("You created this activity",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
                      SizedBox(
                        height: Get.height*0.02,
                      ),
                        ...
                        return Row(
                          children: [
                            InkWell(
                              ...
                              child: Column(
                                children: [
                                  Text("Requests",style: TextStyle(fontSize: 16,fontWeight:  controller.selectedTab.value==1?FontWeight.w700:FontWeight.w400),),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  controller.selectedTab.value==1?Container(
                                    height: 3,
                                    width: 70,
                                    decoration: BoxDecoration(
                                        color: clrYellow,
                            ...
                            InkWell(
                              ...
                              child: Column(
                                children: [
                                  Text("Going",style: TextStyle(fontSize: 16,fontWeight:  controller.selectedTab.value==2?FontWeight.w700:FontWeight.w400)),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  controller.selectedTab.value==2?Container(
                                    height: 3,
                                    width: 70,
                                    decoration: BoxDecoration(
                                        color: clrYellow,
                     ...
                     Obx((){
                       return  controller.selectedTab.value==1? ListView.builder(shrinkWrap: true,itemCount: 3,physics: const NeverScrollableScrollPhysics(),itemBuilder: (context,index){
                         return  Container(
                                   ...
                                   Flexible(
                                     child: Row(
                                       children: [
                                         ...
                                         const Flexible(child: Text("Isabelle Wilson",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16)))
                                       ],
                                     ),
                                   ),
                                   Row(
                                     children: [
                                       ...
                                       InkWell(
                                         ...
                                         child: Container(
                                           ...
                                           child: Icon(Icons.check,color: clrWhite,size: 20,),
                                         ),
                                       )
                                     ],
                                   )
                       ...
                       }):ListView.builder(shrinkWrap: true,itemCount: 4,physics: const NeverScrollableScrollPhysics(),itemBuilder: (context,index){
                         return  Container(
                           margin: const EdgeInsets.symmetric(vertical: 0),
                           child: Column(
                             children: [
                               Row(
                                 ...
                                 children: [
                                   ...
                                   Container(
                                     ...
                                     child: Text("Remove",style: TextStyle(color: clrWhite,fontSize: 12,fontWeight: FontWeight.w700),),
                                   ),
                                 ],
                               ),
                               SizedBox(
                      ...
                      Center(child: InkWell(
                          ...
                          ,child: const Text("Delete activity",style: TextStyle(decoration: TextDecoration.underline),))),
                      SizedBox(
                        height: Get.height*0.02,
                      ),
                    ],

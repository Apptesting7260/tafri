...
class MyProfileUi extends GetWidget<MyprofileInnController> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      //
      //   if (controller.isBackPressedOnce.value) {
      //     return;
      //   }
      //
      //   await controller.profileAlertPopUp(
      //     doLatterTap: () {
      //       controller.isBackPressedOnce.value = true;
      //       Get.back();
      //       Get.back();
      //     },
      //   );
      ...
      // canPop: true,
      onWillPop: () async {
        // Show the popup and wait for user's response
        final shouldNavigateBack = await controller.profileAlertPopUp(
          doLatterTap: () {
            Get.back();
            Get.back();
          },
        ...
        // Return false to prevent immediate back navigation

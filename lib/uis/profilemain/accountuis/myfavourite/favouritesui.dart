        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Obx(
                  () => controller.myfavouriteLoading.value
                      ? Center(
                          child: CommonUi.scaffoldLoading(color: clrYellow),
                        )
                      : controller.favError.value.isNotEmpty
                          ? const ErrorScreen()
                              ...
                              : controller.favData.value.result!
                                  ...
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        var resultData = controller
                                            .favData.value.result
                                            ?.where((result) =>
                                                result.status == 'approved')
                                            .toList();
                                        ...
                                        print(
                                            'Circle Index for index $index: ${controller.favData.value.result?[index].circleIndex?.value}');
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        () =>
                                                                          ...
                                                                          Icons
                                                                              .circle,
                                                                          color: resultData[index].circleIndex?.value == index
                                                                              ? clrYellow
                                                                              : clrWhite,
                                                                          size:
                                                                              8,
                                                    ...
                                                    Flexible(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          // ),
                                                          Text(
                                                            '${resultData[index].formattedDate}${resultData[index].endDate != resultData[index].formattedDate ? ' - ${resultData[index].endDate}' : ''} ${homeController
                                                                .homeData
                                                                .value
                                                                .result
                                                                ?.profileComplete ==
                                                          ...
                                                          Text(
                                                            "Up to ${resultData[index].maxPeople} people | ${resultData[index].spotLeft} ${resultData[index].spotLeft! == 1 ? 'spot left' : 'spots left'}",
                                                            style: TextStyle(
                                                                color:
                                                                    clrYellowText,
                                                                fontSize: 13),

...
class UserProfileUi extends GetWidget<UserProfileController>{
   UserProfileUi({super.key});
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                            controller.hostData.value.result!.previousActivities![index].activities![ind].location.toString() ?? '',
                                                            style: TextStyle(
                                                                color: clrGreyTextLight,
                                                                fontSize: 12)
                                                        ),

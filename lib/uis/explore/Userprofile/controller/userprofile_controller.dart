...
import 'package:plusone/uis/explore/Userprofile/model/userprofile_model.dart';
...
class UserProfileController extends GetxController{
  ...
  var hostData = UserprofileModel().obs;
  var hostError = ''.obs;
  ...
  Future<void> hostapi(String? id) async{
    ...
    try{
      ...
      if(response.statusCode == 200){
        ...
        hostData.value = UserprofileModel.fromJson(response.body);
        interestList.clear();

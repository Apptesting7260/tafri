...
// var controller= Get.put(ExploreController());
  ...
  Widget build(BuildContext context) {
    var h = Get.height;
    var w = Get.width;
    bool isNotch(BuildContext context) {
      final padding = MediaQuery.of(context).padding;
      return padding.top > 20.0; // If top padding is greater than 20, it's likely a notch.
    }
    print('notch == ${isNotch(context)}');
                                              ...
                                              Flexible(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    // ),
                                                    Text(
                                                      '${activityData?[index].formattedDate}${activityData?[index].endDate != activityData?[index].formattedDate ? ' - ${activityData?[index].endDate}' : ''} ${controller.homeData.value.result?.membershipStatus == true && controller.homeData.value.result?.profileComplete == true ? '| ${activityData?[index].startAt} - ${activityData?[index].endAt}' : ''} ',
                                                      style:
                                                      TextStyle(color: clrGreyDark),
                                                    ),
                                                    SizedBox(
               ...
               children: [
                 Padding(
                   padding: EdgeInsets.only(
                       ...
                       right: Res.Defalt_side_margin-10,
                       top: 15
                   ),
                   child: Row(
                     mainAxisAlignment: MainAxisAlignment.spaceAround,

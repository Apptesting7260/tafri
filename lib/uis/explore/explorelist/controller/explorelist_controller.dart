...
class ExploreListController extends GetxController{
  ...
  RxList<Map> exploreListData=[
    {
      ...
      "des":"Hey guys! Looking for 2 others who would like to join me for a picnic in the park today ,we all do games and dinner",
  ...
  changeFav(index){
    exploreListData.value[index]['isFav']=!exploreListData.value[index]['isFav'];
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Row(
                            ...
                            children: [
                              Flexible(child: Text("Become a member",style: TextStyle(fontSize: 15),)),
                              Icon(
                                Icons.arrow_right,
                                size: 30,
                              )
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Flexible(child: Text("Complete profile",style: TextStyle(fontSize: 15))),
                              Icon(
                                Icons.arrow_right,
                                size: 30,
                              )
  ...
  selectCategory(id){
    ...
    for(int i=0;i < categryList.value.length;i++){
      if(categryList.value[i]['id']==id){
        categryList.value[i]['isSelected']=!categryList.value[i]['isSelected'];
      }
    }
    categryList.refresh();
  }

  ...
  void _showCustomDatePicker(BuildContext context,DateTime? date) async {
    DateTime? selectedDate = await showDialog(
      ...
      builder: (BuildContext context) {
        return CustomDateRangePicker(date: date,);
      },
    );
    ...
    if (selectedDate != null) {
      ...
      exploreListController
          .filterDateStart.value = DateFormat('yyyy-MM-dd').format(selectedDate).toString();
                              ...
                              SizedBox(
                                ...
                                child: CustoFilterBtn(
                                  ontap: () {
                                    ...
                                    _showCustomDatePicker(context,DateTime.parse(exploreListController
                                        .filterDateStart.value != '' ? exploreListController
                                        .filterDateStart.value : DateTime.now().toString()));
                                  },
                                  lable: Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                        ...
                        Obx(() {
                          return CustoDropDownBtn(
                              ...
                              prefixIcon: Container(
                                  ...
                                  child: const Image(
                                    image:
                                        AssetImage("assets/icons/gendericon.png"),
                                    height: 3,
                                    width: 3,
                                  )),
                              itemList: const [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Obx(() {
                              return CustomSwitch(
                                value:
                                    exploreListController.hideWaitListAct.value,
                                onChanged: (p0) {

            ...
            Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Obx(() {
                      return Text("${exploreListController.groupSize}");
                    }),
                    SizedBox(
                      width: w * .01,
                    ),
                ...
                children: [
                  SizedBox(
                    ...
                    child: CustoFilterBtn(
                      lable: Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            height: h * .02,
                            color: exploreListController.filterDateStart.value != '' &&
                                    exploreListController.filterDateCalenderEnd.value != ''
                                ? clrWhite
                                : clrBlacke,
                          )),
                          const SizedBox(
                          ...
                          Text(
                              ...
                              style: TextStyle(
                                  color:
                                      exploreListController.filterDateStart.value != '' &&
                                              exploreListController.filterDateCalenderEnd
                                                      .value !=
                                                  ''
                                          ? clrWhite
                                          : clrBlacke,
                      ...
                      ontap: () async {
                        ...
                        if (dateRange != null) {
                          print("gk=====$dateRange");
                          exploreListController.changeFilterDate(dateRange);
                        }
                      },
                      borderClr: clrBlacke,
                      backgroundClr: exploreListController.filterDateStart.value != '' &&
                              exploreListController.filterDateCalenderEnd.value != ''
                          ? clrBlacke
                          : clrWhite,
                    ),
                  ...
                  SizedBox(
                    ...
                    child: CustoFilterBtn(
                      lable: Text("today",
                          style: TextStyle(
                              color: exploreListController.dateFilter['today']
                                  ? clrWhite
                                  : clrBlacke,
                              fontSize: 13)),
                      ontap: () {
                        exploreListController.changeDateFilter("today");
                      },
                      borderClr: clrBlacke,
                      backgroundClr: exploreListController.dateFilter.value['today']
                          ? clrBlacke
                          : clrWhite,
                    ),
                  ),
                  SizedBox(
                    ...
                    child: CustoFilterBtn(
                      lable: Text("tomorrow",
                          style: TextStyle(
                              color: exploreListController.dateFilter.value['tomorrow']
                                  ? clrWhite
                                  : clrBlacke,
                              fontSize: 13)),
                      ontap: () {
                        exploreListController.changeDateFilter("tomorrow");
                      },
                      borderClr: clrBlacke,
                      backgroundClr: exploreListController.dateFilter.value['tomorrow']
                          ? clrBlacke
                          : clrWhite,
                    ),
                  ),
                  SizedBox(
                    ...
                    child: CustoFilterBtn(
                      lable: Text("This week",
                          style: TextStyle(
                              color: exploreListController.dateFilter.value['week']
                                  ? clrWhite
                                  : clrBlacke,
                              fontSize: 13)),
                      ontap: () {
                        exploreListController.changeDateFilter("week");
                      },
                      borderClr: clrBlacke,
                      backgroundClr: exploreListController.dateFilter.value['week']
                          ? clrBlacke
                          : clrWhite,
                    ),
                  ),
                  SizedBox(
                    ...
                    child: CustoFilterBtn(
                      lable: Text("This weekend",
                          style: TextStyle(
                              color: exploreListController.dateFilter.value['weekend']
                                  ? clrWhite
                                  : clrBlacke,
                              fontSize: 13)),
                      ontap: () {
                        exploreListController.changeDateFilter("weekend");
                      },
                      borderClr: clrBlacke,
                      backgroundClr: exploreListController.dateFilter.value['weekend']
                          ? clrBlacke
                          : clrWhite,
                    ),
                  ),
              ...
              child: Obx(() {
                ...
                return CustoDropDownBtn(
                    ...
                    prefixIcon: Container(
                        ...
                        child: const Image(
                          image: AssetImage("assets/icons/timericon.png"),
                          height: 3,
                          width: 3,
                        )),
                    itemList: const [
                ...
                return CustoDropDownBtn(
                    ...
                    prefixIcon: Container(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 12, vertical: 10),
                        child: const Image(
                          image: AssetImage("assets/icons/gendericon.png"),
                          height: 3,
                          width: 3,
                        )),
                    itemList: const [
                ...
                SizedBox(
                    ...
                    child: FittedBox(child: Obx(() {
                      return Switch(
                        ...
                        value: exploreListController.hideWaitListAct.value,
                        onChanged: (val) {
                          exploreListController.changeHideWaitListAct();
                        },
